...
// TZToolKit
#define COCOAPODS_POD_AVAILABLE_TZToolKit
#define COCOAPODS_VERSION_MAJOR_TZToolKit 0
#define COCOAPODS_VERSION_MINOR_TZToolKit 0
#define COCOAPODS_VERSION_PATCH_TZToolKit 1
